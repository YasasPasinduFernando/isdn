...
<form
  ...
  <div class="flex-1 overflow-y-auto p-5 space-y-6">
    ...
    <div>
      ...
      <div class="grid grid-cols-2 gap-3 mt-2">
        <input name="order_date_from" type="date"
          class="rounded-lg border px-3 py-2 w-full focus:ring-2 focus:ring-teal-500 focus:outline-none">
    ...
    <div>
      ...
      <select name="order_status"
        class="mt-2 w-full rounded-lg border px-3 py-2 focus:ring-2 focus:ring-teal-500 focus:outline-none">
  ...
  <div class="p-5 border-t border-white/40 flex gap-3">
    <button type="reset"
      class="w-1/2 border rounded-xl py-2 font-semibold hover:bg-gray-100 transition">
      Clear
    </button>
    <button type="submit"
      class="w-1/2 bg-teal-600 text-white rounded-xl py-2 font-semibold hover:bg-teal-700 transition">
      Apply
    </button>
  </div>
</form>
