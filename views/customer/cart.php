        ...
        <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="glass-panel rounded-3xl overflow-hidden shadow-xl border border-white/50">
                    <div
                        ...
                        <button onclick="clearCart()"
                            ...
                            <span
                                class="material-symbols-rounded text-lg mr-1 group-hover:rotate-12 transition">delete_sweep</span>
                            Remove All
                        </button>
                    </div>
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <div class="flex items-center justify-between mt-4">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <!-- Quantity Control -->
                                                <div
                                                    class="flex items-center border border-gray-200/60 rounded-xl bg-white/60 backdrop-blur-sm shadow-sm">
                                                    <button
                                                        class="qty-minus w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-white rounded-l-xl transition hover:text-teal-600 font-bold">
                                                        -
                                                    </button>
                                                    ...
                                                    <button
                                                        class="qty-plus w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-white rounded-r-xl transition hover:text-teal-600 font-bold">
                                                        +
                                                    </button>
                                                </div>
                                                ...
                                                <!-- Remove -->
                                                <button
                                                    class="remove-btn w-10 h-10 rounded-full bg-red-50 text-red-400 hover:bg-red-500 hover:text-white transition flex items-center justify-center shadow-sm">
                    ...
                    <div class="p-6 bg-white/30 backdrop-blur-sm border-t border-gray-100/50">
                        <a href="index.php?page=products"
                            class="text-teal-600 font-bold hover:text-teal-800 flex items-center transition group">
                            <span
                                class="material-symbols-rounded mr-2 group-hover:-translate-x-1 transition">arrow_back</span>
                            Continue Shopping
                        </a>
                    </div>
                </div>
            ...
            <div class="lg:w-1/3">
                <div class="glass-card rounded-3xl p-6 sticky top-24 border border-white/50">
                    ...
                    <div
                        class="mt-8 flex items-center justify-center space-x-4 opacity-70 grayscale hover:grayscale-0 transition duration-300">
