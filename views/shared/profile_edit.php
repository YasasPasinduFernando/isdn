...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($act === 'update_profile') {
            $profileModel->updateProfile($userId, $role, [
            ...
            $result = $profileModel->changePassword(
                $userId,
...
if (!$profile) {
    flash_message('Profile not found.', 'error');
    redirect('/index.php?page=' . dashboard_page_for_role($role));
}
...
<div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-8">
            <a href="<?php echo BASE_PATH; ?>/index.php?page=<?php echo htmlspecialchars($dashboardPage); ?>" class="w-10 h-10 rounded-xl bg-white/50 border border-white/60 flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-white/70 transition"><span class="material-symbols-rounded">arrow_back</span></a>
            <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="glass-panel rounded-3xl p-6 sm:p-8">
                ...
                <form method="POST" action="<?php echo BASE_PATH; ?>/index.php?page=profile" class="space-y-5">
            ...
            <div class="space-y-8">
                ...
                <div class="glass-card rounded-3xl p-6">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between"><span class="text-gray-500">Joined</span><span class="font-semibold text-gray-800"><?php echo !empty($profile['created_at']) ? date('M j, Y', strtotime($profile['created_at'])) : '-'; ?></span></div>
